...
public class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        if (stmt.superclass != null) {
            if (stmt.name.lexeme.equals(stmt.name.lexeme)) {
                Main.error(stmt.name, "A class can't inherit from itself.");
            }
    ...
    public Void visitVarStmt(Stmt.Var stmt) {
        // this call to declare() seems redundant. won't the subsequent call to define()
        // always overwrite the same key as true?
        declare(stmt.name);
    ...
    private void declare(Token name) {
        ...
        if (scope.containsKey(name.lexeme)) {
            Main.error(name, "Alreadyu a variable with this name in this scope.");
        }
